...
export const KNOWN_INTEGRATION_GAPS = {
  ...
  'content-language-routes.ts': 'no harness test creates, edits or archives a content language over HTTP',
  'library-routes.ts': 'no harness test reads the library over HTTP',
  ...
  'scripture-routes.ts': 'no harness test searches scripture over HTTP',
  ...
  'slide-group-routes.ts': 'no harness test creates, edits or regenerates a Slide Group over HTTP',
  'slide-label-routes.ts': 'no harness test creates, edits or archives a Slide Label over HTTP',
  ...
  'song-routes.ts': 'no harness test creates or edits a Song over HTTP',
