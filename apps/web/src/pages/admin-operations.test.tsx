...
// correctly. A later pass proves each status domain's rendering.
...
describe('AdminOperationsPage', () => {
  ...
  it('renders once the health report has loaded', async () => {
    const fetching = vi.fn<FetchLike>(async () =>
      reply(200, successEnvelope({ health: { at: '2026-09-24T00:00:00.000Z', state: 'ok', action: '', statuses: [] } }, 'request-health')));
